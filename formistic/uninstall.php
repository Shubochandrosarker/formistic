...
$tables = [
	...
	$wpdb->prefix . 'WPISTIC_CF_notes',
	$wpdb->prefix . 'WPISTIC_CF_impressions',
	$wpdb->prefix . 'wpistic_cf_ai_meta',
	$wpdb->prefix . 'WPISTIC_CF_subscribers',
];
...
$options = [
	...
	'WPISTIC_CF_emails_disabled',
	'WPISTIC_CF_trusted_proxies',
	// Captures.
	...
	// AI & Automation.
	'wpistic_cf_ai_provider',
	'wpistic_cf_ai_endpoint',
	'wpistic_cf_ai_model',
	'wpistic_cf_ai_api_key',
	'wpistic_cf_ai_smart_reply_enabled',
	'wpistic_cf_ai_auto_reply_enabled',
	'wpistic_cf_ai_auto_reply_subject',
	'wpistic_cf_ai_auto_reply_rules',
	'wpistic_cf_ai_faq_text',
	'wpistic_cf_ai_kb_text',
	'wpistic_cf_ai_google_sheets_urls',
	'wpistic_cf_ai_text_sources',
];
