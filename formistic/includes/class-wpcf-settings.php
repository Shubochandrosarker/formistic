...
class WPISTIC_CF_Settings {
	...
	protected function render_tab_general() {
		...
		<table class="form-table" role="presentation">
			...
			<tr>
				<th scope="row"><label for="WPISTIC_CF_notify_email"><?php esc_html_e( 'Notification email address', 'formistic' ); ?></label></th>
			...
			<tr>
				<th scope="row"><label for="WPISTIC_CF_reply_from_name"><?php esc_html_e( 'Reply "From" name', 'formistic' ); ?></label></th>
			...
			<tr>
				<th scope="row"><label for="WPISTIC_CF_reply_from_email"><?php esc_html_e( 'Reply "From" email', 'formistic' ); ?></label></th>
			...
			<tr>
				<th scope="row"><label for="WPISTIC_CF_reply_signature"><?php esc_html_e( 'Reply signature', 'formistic' ); ?></label></th>
				<td>
			...
			<tr>
				...
				<td>
					...
					<?php if ( $emails_disabled_const ) : ?>
						<p class="description" style="color:#b32d2e;"><?php esc_html_e( 'Locked: WPCF_EMAIL_DISABLED constant is set in wp-config.php.', 'formistic' ); ?></p>
					<?php endif; ?>
				</td>
			</tr>
		</table>
	...
	protected function render_tab_captures() {
		$rows = [
			'WPISTIC_CF_capture_cf7'     => [ __( 'Contact Form 7',    'formistic' ), '1', __( 'Capture submissions sent via Contact Form 7.', 'formistic' ) ],
			'WPISTIC_CF_capture_wpforms' => [ __( 'WPForms',           'formistic' ), '1', __( 'Capture submissions processed by WPForms.', 'formistic' ) ],
			'WPISTIC_CF_capture_gform'   => [ __( 'Gravity Forms',     'formistic' ), '1', __( 'Capture submissions completed in Gravity Forms.', 'formistic' ) ],
			'WPISTIC_CF_capture_fluent'  => [ __( 'Fluent Forms',      'formistic' ), '1', __( 'Capture submissions stored by Fluent Forms.', 'formistic' ) ],
			'WPISTIC_CF_capture_g2a'     => [ __( 'G2A Theme', 'formistic' ), '1', __( 'Capture theme-bundled g2a_request / g2a_reservation form handlers.', 'formistic' ) ],
			'WPISTIC_CF_capture_wpmail'  => [ __( 'wp_mail intercept', 'formistic' ), '0', __( 'Catch-all: record a snapshot of any outgoing email triggered by a form submission. Use with care — also captures non-form site emails (password resets, comment notifications, etc).', 'formistic' ) ],
		];
		?>
	...
	protected function render_tab_spam() {
		...
		<table class="form-table" role="presentation">
			...
			<tr>
				<th scope="row"><label for="WPISTIC_CF_spam_recaptcha_site_key"><?php esc_html_e( 'Site key', 'formistic' ); ?></label></th>
			...
			<tr>
				<th scope="row"><label for="WPISTIC_CF_spam_recaptcha_secret_key"><?php esc_html_e( 'Secret key', 'formistic' ); ?></label></th>
			...
			<tr>
				<th scope="row"><label for="WPISTIC_CF_spam_recaptcha_threshold"><?php esc_html_e( 'Minimum score', 'formistic' ); ?></label></th>
				<td>
		...
		<table class="form-table" role="presentation">
			...
			<tr>
				<th scope="row"><label for="WPISTIC_CF_spam_turnstile_site_key"><?php esc_html_e( 'Site key', 'formistic' ); ?></label></th>
			...
			<tr>
				<th scope="row"><label for="WPISTIC_CF_spam_turnstile_secret_key"><?php esc_html_e( 'Secret key', 'formistic' ); ?></label></th>
		...
		<table class="form-table" role="presentation">
			<tr>
				<th scope="row"><label for="WPISTIC_CF_spam_ip_blocklist"><?php esc_html_e( 'Blocked IPs', 'formistic' ); ?></label></th>
				<td>
		...
		<table class="form-table" role="presentation">
			...
			<tr>
				<th scope="row"><label for="WPISTIC_CF_spam_rate_limit_max"><?php esc_html_e( 'Max submissions', 'formistic' ); ?></label></th>
			...
			<tr>
				<th scope="row"><label for="WPISTIC_CF_spam_rate_limit_window"><?php esc_html_e( 'Window (seconds)', 'formistic' ); ?></label></th>
				<td>
			...
			<tr>
				...
				<td>
					...
					<?php if ( $proxies_const ) : ?>
						<p class="description" style="color:#b32d2e;"><?php esc_html_e( 'Locked: WPCF_TRUSTED_PROXIES constant is set in wp-config.php.', 'formistic' ); ?></p>
					<?php endif; ?>
				</td>
			</tr>
		</table>
	...
	protected function render_tab_autoresponder() {
		...
		<table class="form-table" role="presentation">
			...
			<tr>
				<th scope="row"><label for="WPISTIC_CF_ar_subject"><?php esc_html_e( 'Subject', 'formistic' ); ?></label></th>
				<td><input type="text" class="regular-text" id="WPISTIC_CF_ar_subject" name="WPISTIC_CF_ar_subject" value="<?php echo esc_attr( get_option( 'WPISTIC_CF_ar_subject', __( 'Thanks for contacting {site_name}', 'formistic' ) ) ); ?>"></td>
			</tr>
			<tr>
				<th scope="row"><label for="WPISTIC_CF_ar_body"><?php esc_html_e( 'Message body', 'formistic' ); ?></label></th>
				<td>
	...
	protected function render_tab_gdpr() {
		...
		<table class="form-table" role="presentation">
			...
			<tr>
				<th scope="row"><label for="WPISTIC_CF_gdpr_consent_text"><?php esc_html_e( 'Consent text', 'formistic' ); ?></label></th>
				<td>
					<input type="text" class="large-text" id="WPISTIC_CF_gdpr_consent_text" name="WPISTIC_CF_gdpr_consent_text" value="<?php echo esc_attr( get_option( 'WPISTIC_CF_gdpr_consent_text', __( 'I agree to the processing of my personal data as described in the privacy policy.', 'formistic' ) ) ); ?>">
			...
			<tr>
				<th scope="row"><label for="WPISTIC_CF_gdpr_autopurge_days"><?php esc_html_e( 'Retention (days)', 'formistic' ); ?></label></th>
				<td>
	...
	protected function render_tab_webhooks() {
		...
		<table class="form-table" role="presentation">
			...
			<tr>
				<th scope="row"><label for="WPISTIC_CF_webhook_urls"><?php esc_html_e( 'Webhook URLs', 'formistic' ); ?></label></th>
				<td>
			...
			<tr>
				<th scope="row"><label for="WPISTIC_CF_webhook_secret"><?php esc_html_e( 'Signing secret', 'formistic' ); ?></label></th>
				<td>
					...
					<p class="description"><?php esc_html_e( 'Optional. If set, every request includes an X-WPISTIC_CF-Signature: sha256=<HMAC> header so your endpoint can verify authenticity.', 'formistic' ); ?></p>
				</td>
			</tr>
			<tr>
  ...
  "dashboard_url": "..."
	...
	protected function render_tab_templates() {
		...
		<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
			...
			<table class="form-table" role="presentation">
				<tr>
					<th><label for="WPISTIC_CF_template_name"><?php esc_html_e( 'Name', 'formistic' ); ?></label></th>
				...
				<tr>
					<th><label for="WPISTIC_CF_template_subject"><?php esc_html_e( 'Subject (optional)', 'formistic' ); ?></label></th>
					<td>
				...
				<tr>
					<th><label for="WPISTIC_CF_template_body"><?php esc_html_e( 'Body', 'formistic' ); ?></label></th>
					<td>
	...
	protected function render_tab_ai() {
		...
		<table class="form-table" role="presentation">
			<tr>
				<th scope="row"><label for="wpistic_cf_ai_provider"><?php esc_html_e( 'Provider', 'formistic' ); ?></label></th>
				<td>
					<select id="wpistic_cf_ai_provider" name="wpistic_cf_ai_provider">
						<option value="local_rules" <?php selected( get_option( 'wpistic_cf_ai_provider', 'local_rules' ), 'local_rules' ); ?>><?php esc_html_e( 'Local Rules (No API, Free)', 'formistic' ); ?></option>
						<option value="ollama" <?php selected( get_option( 'wpistic_cf_ai_provider', '' ), 'ollama' ); ?>><?php esc_html_e( 'Ollama (Local LLM, Free)', 'formistic' ); ?></option>
						<option value="openrouter" <?php selected( get_option( 'wpistic_cf_ai_provider', '' ), 'openrouter' ); ?>><?php esc_html_e( 'OpenRouter (Free model routes)', 'formistic' ); ?></option>
						<option value="huggingface" <?php selected( get_option( 'wpistic_cf_ai_provider', '' ), 'huggingface' ); ?>><?php esc_html_e( 'HuggingFace Inference (free tier)', 'formistic' ); ?></option>
						<option value="custom" <?php selected( get_option( 'wpistic_cf_ai_provider', '' ), 'custom' ); ?>><?php esc_html_e( 'Custom Endpoint', 'formistic' ); ?></option>
					</select>
					<p class="description"><?php esc_html_e( 'Use Local Rules if you want zero external dependency.', 'formistic' ); ?></p>
				</td>
			</tr>
			<tr>
				<th scope="row"><label for="wpistic_cf_ai_endpoint"><?php esc_html_e( 'API Endpoint', 'formistic' ); ?></label></th>
			...
			<tr>
				<th scope="row"><label for="wpistic_cf_ai_model"><?php esc_html_e( 'Model', 'formistic' ); ?></label></th>
			...
			<tr>
				<th scope="row"><label for="wpistic_cf_ai_api_key"><?php esc_html_e( 'API Key (optional)', 'formistic' ); ?></label></th>
		...
		<table class="form-table" role="presentation">
			<tr>
				<th scope="row"><label for="wpistic_cf_ai_faq_text"><?php esc_html_e( 'FAQs', 'formistic' ); ?></label></th>
			...
			<tr>
				<th scope="row"><label for="wpistic_cf_ai_kb_text"><?php esc_html_e( 'Knowledge Base', 'formistic' ); ?></label></th>
			...
			<tr>
				<th scope="row"><label for="wpistic_cf_ai_google_sheets_urls"><?php esc_html_e( 'Google Sheets URLs', 'formistic' ); ?></label></th>
				<td>
			...
			<tr>
				<th scope="row"><label for="wpistic_cf_ai_text_sources"><?php esc_html_e( 'Text File Sources', 'formistic' ); ?></label></th>
				<td>
		...
		<table class="form-table" role="presentation">
			<tr>
				...
				<td><input type="hidden" name="wpistic_cf_ai_smart_reply_enabled" value="0"><label><input type="checkbox" name="wpistic_cf_ai_smart_reply_enabled" value="1" <?php checked( get_option( 'wpistic_cf_ai_smart_reply_enabled', '0' ), '1' ); ?>> <?php esc_html_e( 'Generate AI reply drafts and tags', 'formistic' ); ?></label></td>
			</tr>
			<tr>
				<th scope="row"><?php esc_html_e( 'Enable Auto Reply Send', 'formistic' ); ?></th>
				<td><input type="hidden" name="wpistic_cf_ai_auto_reply_enabled" value="0"><label><input type="checkbox" name="wpistic_cf_ai_auto_reply_enabled" value="1" <?php checked( get_option( 'wpistic_cf_ai_auto_reply_enabled', '0' ), '1' ); ?>> <?php esc_html_e( 'Automatically send replies based on rules/AI', 'formistic' ); ?></label></td>
			</tr>
			<tr>
				<th scope="row"><label for="wpistic_cf_ai_auto_reply_subject"><?php esc_html_e( 'Auto Reply Subject', 'formistic' ); ?></label></th>
			...
			<tr>
				<th scope="row"><label for="wpistic_cf_ai_auto_reply_rules"><?php esc_html_e( 'Easy Automation Rules', 'formistic' ); ?></label></th>
				<td>
	...
	protected function render_tab_attachments() {
		...
		<table class="form-table" role="presentation">
			...
			<tr>
				<th scope="row"><label for="WPISTIC_CF_att_max_size_mb"><?php esc_html_e( 'Max file size (MB)', 'formistic' ); ?></label></th>
				<td>
			...
			<tr>
				<th scope="row"><label for="WPISTIC_CF_att_allowed_types"><?php esc_html_e( 'Allowed extensions', 'formistic' ); ?></label></th>
				<td>
