...
class WPISTIC_CF_Forms {
	...
	public function list_columns( $cols ) {
		...
		foreach ( $cols as $key => $label ) {
			$new[ $key ] = $label;
			if ( 'title' === $key ) {
				$new['WPISTIC_CF_shortcode'] = __( 'Shortcode', 'formistic' );
				$new['WPISTIC_CF_fields']    = __( 'Fields',    'formistic' );
			}
		}
		return $new;
	}
	...
	public function metaboxes() {
		add_meta_box( 'WPISTIC_CF_fields_editor', __( 'Form Fields', 'formistic' ),
			[ $this, 'render_fields_metabox' ], self::POST_TYPE, 'normal', 'high' );
		add_meta_box( 'WPISTIC_CF_form_settings', __( 'Notifications & Display', 'formistic' ),
			[ $this, 'render_settings_metabox' ], self::POST_TYPE, 'normal', 'default' );
		add_meta_box( 'WPISTIC_CF_form_shortcode', __( 'Shortcode', 'formistic' ),
	...
	public function render_fields_metabox( $post ) {
		...
		<div class="WPISTIC_CF-fields-editor">
			...
			<p>
				<button type="button" class="button" id="WPISTIC_CF-fields-editor-add"><?php esc_html_e( '+ Add Field', 'formistic' ); ?></button>
			</p>
		...
		<div class="WPISTIC_CF-field-row" data-index="<?php echo esc_attr( $i ); ?>">
			...
			<div class="WPISTIC_CF-field-row__main">
				<label class="WPISTIC_CF-field-row__label">
					...
					<input type="text" name="WPISTIC_CF_fields[<?php echo esc_attr( $i ); ?>][label]" value="<?php echo esc_attr( $label ); ?>" placeholder="<?php esc_attr_e( 'e.g. Your Name', 'formistic' ); ?>">
				</label>
				...
				<button type="button" class="button-link WPISTIC_CF-field-row__remove" aria-label="<?php esc_attr_e( 'Remove field', 'formistic' ); ?>">&times;</button>
			</div>
	...
	public function render_settings_metabox( $post ) {
		...
		<table class="form-table" role="presentation">
			<tr>
				<th><label for="WPISTIC_CF_recipients"><?php esc_html_e( 'Notification recipients', 'formistic' ); ?></label></th>
				<td>
			...
			<tr>
				<th><label for="WPISTIC_CF_submit_label"><?php esc_html_e( 'Submit button label', 'formistic' ); ?></label></th>
			...
			<tr>
				<th><label for="WPISTIC_CF_success"><?php esc_html_e( 'Success message', 'formistic' ); ?></label></th>
			...
			<tr>
				<th><label for="WPISTIC_CF_redirect"><?php esc_html_e( 'Redirect after success (optional)', 'formistic' ); ?></label></th>
				<td>
	...
	public function handle_submit() {
		...
		if ( '' !== $override ) {
			...
			if ( $recipients ) {
				...
				$body .= "\n" . __( 'View & reply:', 'formistic' ) . ' ' . admin_url( 'admin.php?page=wpistic-contact&view=' . (int) $sub_id );
